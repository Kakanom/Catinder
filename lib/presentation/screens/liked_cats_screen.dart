  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CatBloc, CatState>(
      builder: (context, state) {
        ...
        final effectiveSelectedBreed =
            selectedBreed != null && breeds.contains(selectedBreed)
                ? selectedBreed
                : null;
                ...
                child: catsToShow.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Dismissible(
                            key: Key(
                                '${cat.id}_${cat.likedAt?.millisecondsSinceEpoch}'),
                            ...
                            onDismissed: (_) {
                              context
                                  .read<CatBloc>()
                                  .add(RemoveLikedCatEvent(cat));
                              final updatedBreeds = _availableBreeds(
                                  state.likedCats..remove(cat));
                              if (selectedBreed != null &&
                                  !updatedBreeds.contains(selectedBreed)) {
                                setState(() => selectedBreed = null);
                              }
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content:
                                      Text('Removed ${cat.breedName ?? 'cat'}'),
